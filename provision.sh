...
listDnsResult="$(curl --header "X-Auth-Key: $CLOUDFLAREKEY" --header "X-Auth-Email: $CLOUDFLAREEMAIL" https://api.cloudflare.com/client/v4/zones/3d7a85d315c8ff6541921c7c2bce9abe/dns_records)"
